...
- Linear dimensionality reduction (e.g., PCA, tPCA) assumes that the underlying structure of the data is flat. PCA, for example, captures the absolute highest amount of variance in the high dimensional data. 
